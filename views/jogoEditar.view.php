...
<head>
    ...
    <title>Editar Jogo | WIkiGames</title>
...
<body class="text-white">
        ...
        <div class="form-container rounded-2xl p-8 sm:p-10 w-full max-w-3xl mx-auto">
            <div class="text-center mb-10">
                <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full mb-6 relative">
                    <i class="fas fa-edit text-3xl text-white animate-float"></i>
                ...
                <p class="text-lg text-gray-300">Atualize os detalhes de <?= htmlspecialchars($jogo['titulo']); ?></p>
            </div>
            ...
            <form action="/editarJogo" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="titulo" id="titulo" value="<?= htmlspecialchars($jogo['titulo']); ?>" placeholder="Ex: The Legend of Zelda" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="autor" id="autor" value="<?= htmlspecialchars($jogo['autor']); ?>" placeholder="Ex: Nintendo EPD" required
                                class="input-field w-full px-4 py-3 pl-10 rounded-lg text-white placeholder-gray-400 focus:outline-none">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="genero" id="genero" value="<?= htmlspecialchars($jogo['genero']); ?>" placeholder="Ex: Ação, Aventura" required
                                class="input-field w-full px-4 py-3 pl-10 rounded-lg text-white placeholder-gray-400 focus:outline-none">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="ano_lancamento" id="ano_lancamento" value="<?= htmlspecialchars($jogo['ano_lancamento']); ?>" placeholder="Ex: 2023" required
                                class="input-field w-full px-4 py-3 pl-10 rounded-lg text-white placeholder-gray-400 focus:outline-none">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea name="descricao" id="descricao" rows="5" placeholder="Descreva sobre o jogo..." required
                            class="input-field w-full px-4 py-3 pl-10 rounded-lg text-white placeholder-gray-400 focus:outline-none"><?= htmlspecialchars($jogo['descricao']); ?></textarea>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">
                        <i class="fas fa-image mr-2 text-pink-400"></i>Imagem Atual do Jogo
                    </label>
                    <?php if (!empty($jogo['imagem'])): ?>
                        <div class="relative overflow-hidden rounded-xl mb-4 shadow-xl">
                            <img class="w-full game-image-preview" 
                            ...
                            <div class="absolute bottom-4 left-4 bg-gray-900/80 text-white px-3 py-1 rounded-full text-sm font-medium">
                                <i class="fas fa-image mr-1"></i> Imagem atual
                            </div>
                        </div>
                    <?php endif; ?>

                    <label for="imagem" class="block text-sm font-medium text-gray-300 mb-2">
                        <i class="fas fa-sync-alt mr-2 text-blue-400"></i>Atualizar Imagem (opcional)
                    </label>
                    <div class="file-upload">
                        <label for="imagem" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-600 rounded-lg cursor-pointer bg-gray-700/50 hover:bg-gray-700/70 transition-colors">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6" id="file-upload-content">
                                ...
                                <p class="mb-2 text-sm text-gray-400">Clique para enviar ou arraste uma nova imagem</p>
                ...
                <div class="pt-4 flex flex-col sm:flex-row gap-4">
                    <a href="<?= BASE_URL ?>jogoDetalhes?id=<?= $jogo['id'] ?>" 
                       class="bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-4 rounded-lg text-lg flex items-center justify-center transition-colors">
                        <i class="fas fa-times mr-2"></i>Cancelar
                    </a>
                    <button type="submit" name="alterar_jogo"
    ...
    <script>
        ...
        document.querySelectorAll('.submit-btn, .bg-gray-700').forEach(button => {
